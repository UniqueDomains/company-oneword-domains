# Available .COMPANY One-Word Domains (7,651)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C647%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-7%2C651%20domains-6f42c1">
...
> **Important:** this repository is a **public 7,647-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **7,651 domains** on the canonical page below.

**Public extract:** 7,647 rows · **Live catalog:** 7,651 domains
...
- `company.csv` — public CSV extract (7,647 rows)
- `company.json` — public JSON extract (7,647 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,647-row public sample | 7,651 live domains                               |
...
> Unique Domains. *Available .COMPANY One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
